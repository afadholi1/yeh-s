    ...
    let membersData = [
        {
            ...
            name: 'Fadholi',
            debts: [
                { date: '2025-07-25', amount: 78000, description: 'Beli headset bluetooth', status: 'Belum Lunas' },
            
                { date: '2024-05-10', amount: 50000, description: 'Buat makan', status: 'Lunas' }
            ]
        },
        {
            id: 2,
            name: 'Mushonnef',
            debts: [
                // { date: '2023-11-01', amount: 100000, description: 'Pinjaman Modal Usaha', status: 'Lunas' },
